        ...
        const cardHTML = `
            <div class="journal-entry-card ${isPrivate ? 'private' : ''} classification-${classification}" 
                ...
                <div class="journal-entry-main">
                    ...
                    <div class="journal-entry-title" contenteditable="true">${cleanTitle}${window.MyDayHub_Config?.DEVMODE && (typeof isDebugAidEnabled === 'function' ? isDebugAidEnabled('debug_show_entry_ids') : true) ? ` [${entry.entry_id}]` : ''}</div>
