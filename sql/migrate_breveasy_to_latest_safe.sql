-- Safe Migration SQL to update breveasy.com database to latest schema
-- This version checks for existing columns/tables before adding them
...
-- ==========================================================================
-- 4. CREATE DATABASE VIEWS (WITH CHECKS)
-- ==========================================================================
